...
//Este método se ejecuta antes del método principal y cada vez que iniciamos la aplicación. En este método, incluiremos la configuración que indica a dónde deben enviarse los errores:
func init() {
